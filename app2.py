...
DEFAULT_MESSAGES = [
    ...
    "תודה לה׳-",
    "אתה אור עולמי-",
    "שמור עליי בדרך הישרה-",
    "הלב מתמלא באמונה-",
    "חסדך מלווה אותי תמיד-",
    "השבח לאל שבראני-",
    "הנפש מצאה מרגוע-",
    "אל תעזוב אותי-",
    "האור בוא יבוא-",
    ...
    "הדרך פתוחה בפניי-",
    "אל תעזוב אותי בשעות קשות-",
    "הגעתי למנוחה-",
    "השאיפה לשלום פנימי-",
    "החיים הם מתנה-",
    "אני עובר תקופה קשה, אבל אעשה זאת-",
    "תחזיק אותי חזק-",
    "כל יום הוא מתנה-",
    "יש לי תחושת ביטחון-",
    "כל צעד מוביל אותי קדימה-",
    "אני תמיד אתמוך בך-",
    "אני לא לבד-",
    "כל תפילה נשמעת-",
    "אני בדרך הנכונה-",
    "ידה של אהבה אוחזת בי-",
    "כל קושי הוא הזדמנות-",
    "תודה על כל דבר קטן-",
    "אני מלא תקווה-",
    "תחושת שקט עוטפת אותי-",
    "יש לי את האמונה בכל דבר-",
    "התפילות שלי נשמעות-",
    "נפתח לי דרך חדשה-"
]
...
🌟 אביגדור בן כוכבה ציפורה 
💍 זיווג טוב ומתאים בקלות ובשמחה

🌟 יאיר בן ספיר
🎓 הצלחה בלימודים

בתוך כל שאר בית ישראל בחן ובחסד וברחמים בקרוב.
-----------------"""
